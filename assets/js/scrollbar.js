		...
		var t,
			...
			u = {
				init: function (t) {
					...
					if (t.live) {
						var s =
								t.liveSelector || this.selector || n,
							c = e(s);
						...
						if (t.data(a)) {
							...
							'x' !== i.axis &&
								...
								o &&
									...
									'function' ==
										typeof i.callbacks.onImageLoad
			...
			v = function () {
				...
				'y' === i.axis ||
					...
					'outside' === i.scrollbarPosition
						...
						: (m.addClass('mCSB_inside').append(c),
							p.wrap(u)),
					w.call(this);
				var g = [
			...
			C = function () {
				var t = e(this),
					...
					s = [
						l[0] /
							(r[0].parent().height() - r[0].height()),
						l[1] /
							(r[1].parent().width() - r[1].width()),
					];
			...
			M = function () {
				...
				n.advanced.releaseDraggableSelectors &&
					l.add(
						e(n.advanced.releaseDraggableSelectors)
					),
					o.bindEvents &&
						(e(document).unbind('.' + i),
						l.each(function () {
			...
			O = function (t) {
				var o = e(this),
					...
					i = n.opt,
					r = e(
						'#mCSB_' + n.idx + '_container_wrapper'
					),
					l = r.length
						? r
					...
					s = [
						...
						e(
							'#mCSB_' + n.idx + '_scrollbar_horizontal'
						),
					],
					c = [
			...
			R = function () {
				...
				var n,
					...
					g = u.advanced.releaseDraggableSelectors
						? p.add(
								e(u.advanced.releaseDraggableSelectors)
							)
						: p;
				p
					.bind(
				...
				function r(e) {
					if (ee(e) && !c && !I(e)[2]) {
						...
						if (!(g - p > 30)) {
							...
							var C =
								parseInt(B.contentTouchScroll) || 0;
							(_[0] = d[0] > C ? _[0] : 0),
								(_[1] = d[1] > C ? _[1] : 0),
								y.overflowed[0] &&
									s(_[0], w[0], n, 'y', W, !1),
			...
			W = function () {
				...
				if (e(this).data(a)) {
					var o = e(this),
						...
						d = e('#mCSB_' + n.idx + '_container').find(
							'iframe'
						);
					d.length &&
						d.each(function () {
				...
				s.bind(
					...
					function (a) {
						...
						if ((a.preventDefault(), $(a))) {
							...
							switch (
								((i.type = n.scrollButtons.scrollType),
								a.type)
							) {
								case 'mousedown':
								case 'touchstart':
			...
			q = function (t, o, n, i, r) {
				function l(e) {
					var o = 'stepped' !== f.type,
						...
						m =
							'x' === f.dir[0]
								? s[1] +
									f.dir[1] * parseInt(f.scrollAmount)
								: s[0] +
									f.dir[1] * parseInt(f.scrollAmount),
				...
				var c = t.data(a),
					...
					p =
						u.scrollInertia < 26 ? 26 : u.scrollInertia,
					g =
						u.scrollInertia < 1 ? 17 : u.scrollInertia;
				switch (o) {
					case 'on':
						if (
							((f.dir = [
			...
			X = function (t) {
				...
				var m,
					...
					x = [
						...
						e(
							'#mCSB_' + c.idx + '_scrollbar_horizontal'
						),
					],
					_ = function () {
						return [
				...
				if (
					...
					switch (
						...
						(!s.contentReset.x && t[0].mcs) ||
							...
							(s.contentReset.x = null)),
						c.snapAmount &&
							(o = N(o, c.snapAmount, c.snapOffset)),
						n.dir)
					) {
						case 'x':
							var v = e(
